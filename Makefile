all: ev3dev.a example1.o h_crane.o
	arm-linux-gnueabi-g++-4.7 -L. -o example1 example1.o h_crane.o -lev3dev
...
example1.o: example1.cpp
		arm-linux-gnueabi-g++-4.7 -c example1.cpp -o example1.o -std=c++11 -D_GLIBCXX_USE_NANOSLEEP
