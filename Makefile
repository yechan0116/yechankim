all: ev3dev.a example0.o h_crane.o
	arm-linux-gnueabi-g++-4.7 -L. -o example0 example0.o h_crane.o -lev3dev
...
example0.o: example0.cpp
		arm-linux-gnueabi-g++-4.7 -c example0.cpp -o example0.o -std=c++11 -D_GLIBCXX_USE_NANOSLEEP
